...
const buttonLeft = document.querySelector(".sliderCont__leftbtn")
const buttonRight = document.querySelector(".sliderCont__rightbtn") 
const movingSlider = document.querySelector(".sliderCont__slick-track")
let counter = 0
//!* let screenWidth = screen.width; //!   EKRAN GENISLIGI


buttonLeft.addEventListener("click", () => {
    movingSlider.style.transition = "all 0.5s ease 0s"
    counter += 1133
    if(counter == 2266){
        counter = -1133
    }
    movingSlider.style.transform = `translate3d(${counter}px, 0px, 0px)`
